...
public class DetailsActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    @BindView(R.id.textView_bakeryNameDetails)
    ...
    String name, cityBlockName;
    Double longitude, latitude, noVotes, votesSum;
    Intent intent;
    Bundle extras;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        name = extras.getString(Constants.bakeryName);
        ...
        cityBlockName = extras.getString(Constants.cityBlockName);
    ...
    public void onMapReady(final GoogleMap googleMap) {
        ...
        String name = extras.getString(Constants.bakeryName);
    ...
    private void setData() {
        ...
        textView_bakeryName.setText(name);
    ...
    private void addToFirebase(double votesSum, double noVotes) {
        ...
        DatabaseReference newEntry = FirebaseDatabase.getInstance().getReference().child("cityBlocks").child(cityBlockName).child(name);
